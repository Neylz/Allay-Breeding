...
summon bee ~ ~ ~ {CannotEnterHiveTicks:10000,LoveCause:[I;0,0,0,0],InLove:1200,Age:0,Invulnerable:1b,ActiveEffects:[{Id:14,Amplifier:0,Duration:2147483647,ShowParticles:false}],Tags:["abr_bee1","abr_process","abr_bee"],Passengers:[{id:"minecraft:allay",Tags:["abr_breeder","abr_breederOnBee1"],Invulnerable:1b}]}

tag @s add abr_processAllay1
execute as @e[type=minecraft:allay,tag=abr_breederInRangeSelected,tag=!abr_processAllay1] at @s run summon bee ~ ~ ~ {CannotEnterHiveTicks:10000, LoveCause:[I;0,0,0,0],InLove:1200,Age:0,Invulnerable:1b,ActiveEffects:[{Id:14,Amplifier:0,Duration:2147483647,ShowParticles:false}],Tags:["abr_bee2","abr_process","abr_bee"],Passengers:[{id:"minecraft:allay",Tags:["abr_breeder","abr_breederOnBee2"],Invulnerable:1b}]}
